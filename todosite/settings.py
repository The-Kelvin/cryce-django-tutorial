...
# Prevent EMAIL SENDING in Test Mode
TESTING = len(sys.argv) > 1 and sys.argv == 'test'

# When debug is set to False we must set allowed hosts
ALLOWED_HOSTS = ['127.0.0.1', 'localhost']


# Set a login url to make sure the login_required decorator behaves correctly
